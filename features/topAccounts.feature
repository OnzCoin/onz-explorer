Feature: Top Accounts page
  Scenario: should show title, summary, and transactions
    ...
    And I should see table "top accounts" with 50 rows starting with:
      ...
      |------|-----------------------|-----------------------|--------------|----------------|
      | 1    | 15323650579610211509Z | 99,675,450.108366 ONZ | /99\.\d{2}%/ | N/A            |
      | 2    | 4401082358022424760L  | 9,971 ONZ             | /0\.\d{2}%/  | gottavoteemall |
      | 3    | 18234943547133247982L | 6,229.88999424 ONZ    | /0\.\d{2}%/  | N/A            |
      | 4    | 14895491440237132212L | 3,735.41000576 ONZ    | /0\.\d{2}%/  | standby_301    |
      | 5    | 537318935439898807L   | /3,288.\d{8} ONZ/     | /0\.\d{2}%/  | genesis_17     |
