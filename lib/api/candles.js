...
module.exports = function (app) {
	const exchanges = {
		...
		graviex: new candles.graviex(app.locals.redis),
	};
	...
	this.getStatistics = function (e, error, success) {
		...
		(err, results) => {
			...
			let statistics = {
				...
				onzVolume: _.reduce(results[0], (memo, t) =>
					(memo + parseFloat(t.onzVolume)), 0.0).toFixed(8),
			...
			statistics = {
				...
				onzVolume: statistics.onzVolume,
