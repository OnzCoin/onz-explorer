module.exports = function (app, api) {
	...
	const addressReg = /^ONZ[a-zA-Z0-9]{33}$/;
	/*
	* with new address, transaction id is same as publicKeyReg. Replacing search with Txn id instead
	* TODO : Reg to distinguish publicKeyReg and txnIdReg 
	* const publicKeyReg = /^[0-9a-f]{64}$/;
	*/ 
	const txnIdReg = /^[0-9a-f]{64}$/;
